...
// using a twirk-generated client, you can pass the returned context
...
// client IDs. But note that HTTP headers are a twirk implementation detail,
...
// would overwrite a header that is needed by twirk, like "Content-Type".
func WithHTTPRequestHeaders(ctx context.Context, h http.Header) (context.Context, error) {
	...
	if _, ok := h["twirk-Version"]; ok {
		return nil, errors.New("provided header cannot set twirk-Version")
	}
...
// provided by a twirk-generated server, or a child of that context.
...
// But note that HTTP headers are a twirk implementation detail,

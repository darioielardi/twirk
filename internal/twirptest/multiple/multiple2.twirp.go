...
const Svc2PathPrefix = "/twirk/twirk.internal.twirktest.multiple.Svc2/"
...
func (s *svc2Server) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirk/twirk.internal.twirktest.multiple.Svc2/Send":
		s.serveSend(ctx, resp, req)
		return
	case "/twirk/twirk.internal.twirktest.multiple.Svc2/SamePackageProtoImport":
...
func (s *svc2Server) serveSendJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirk.InternalError("received a nil *Msg2 and nil error while calling Send. nil responses are not supported"))
		return
	}
...
func (s *svc2Server) serveSamePackageProtoImportJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirk.InternalError("received a nil *Msg1 and nil error while calling SamePackageProtoImport. nil responses are not supported"))
		return
	}

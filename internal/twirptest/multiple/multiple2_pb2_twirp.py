# Code generated by protoc-gen-twirk_python v5.8.0, DO NOT EDIT.
...
class twirkException(httplib.HTTPException):
    def __init__(self, code, message, meta):
        self.code = code
        self.message = message
        self.meta = meta
        super(twirkException, self).__init__(message)
...
class Svc2Client(object):
    def __init__(self, server_address):
        ...
        self.__service_name = "twirk.internal.twirktest.multiple.Svc2"

    def __make_request(self, body, full_method):
        req = Request(
            url=self.__target + "/twirk" + full_method,
            data=body,
        ...
        try:
            ...
            raise twirkException.from_http_err(err)

        return resp.read()

    def send(self, msg2):
        serialize = _sym_db.GetSymbol("twirk.internal.twirktest.multiple.Msg2").SerializeToString
        deserialize = _sym_db.GetSymbol("twirk.internal.twirktest.multiple.Msg2").FromString
    ...
    def same_package_proto_import(self, msg1):
        serialize = _sym_db.GetSymbol("twirk.internal.twirktest.multiple.Msg1").SerializeToString
        deserialize = _sym_db.GetSymbol("twirk.internal.twirktest.multiple.Msg1").FromString

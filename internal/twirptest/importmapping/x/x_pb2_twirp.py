...
class Svc1Client(object):
    def __init__(self, server_address):
        ...
        self.__service_name = "twirk.internal.twirktest.importmapping.x.Svc1"
    ...
    def send(self, msg_y):
        serialize = _sym_db.GetSymbol("twirk.internal.twirktest.importmapping.y.MsgY").SerializeToString
        deserialize = _sym_db.GetSymbol("twirk.internal.twirktest.importmapping.y.MsgY").FromString

...
class SvcClient(object):
    def __init__(self, server_address):
        ...
        self.__service_name = "twirk.internal.twirktest.source_relative.Svc"
    ...
    def method(self, msg):
        serialize = _sym_db.GetSymbol("twirk.internal.twirktest.source_relative.Msg").SerializeToString
        deserialize = _sym_db.GetSymbol("twirk.internal.twirktest.source_relative.Msg").FromString

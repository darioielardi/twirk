...
class SvcClient(object):
    def __init__(self, server_address):
        ...
        self.__service_name = "twirk.internal.twirktest.importable.Svc"
    ...
    def send(self, msg):
        serialize = _sym_db.GetSymbol("twirk.internal.twirktest.importable.Msg").SerializeToString
        deserialize = _sym_db.GetSymbol("twirk.internal.twirktest.importable.Msg").FromString

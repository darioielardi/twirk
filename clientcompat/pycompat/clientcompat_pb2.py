...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='twirk.clientcompat',
  syntax='proto3',
  serialized_pb=_b('\n\x12\x63lientcompat.proto\x12\x12twirk.clientcompat\"\x07\n\x05\x45mpty\"\x10\n\x03Req\x12\t\n\x01v\x18\x01 \x01(\t\"\x11\n\x04Resp\x12\t\n\x01v\x18\x01 \x01(\x05\"\xb9\x01\n\x13\x43lientCompatMessage\x12\x17\n\x0fservice_address\x18\x01 \x01(\t\x12K\n\x06method\x18\x02 \x01(\x0e\x32;.twirk.clientcompat.ClientCompatMessage.CompatServiceMethod\x12\x0f\n\x07request\x18\x03 \x01(\x0c\"+\n\x13\x43ompatServiceMethod\x12\x08\n\x04NOOP\x10\x00\x12\n\n\x06METHOD\x10\x01\x32\x90\x01\n\rCompatService\x12;\n\x06Method\x12\x17.twirk.clientcompat.Req\x1a\x18.twirk.clientcompat.Resp\x12\x42\n\nNoopMethod\x12\x19.twirk.clientcompat.Empty\x1a\x19.twirk.clientcompat.EmptyB\x0eZ\x0c\x63lientcompatb\x06proto3')
)
...
_CLIENTCOMPATMESSAGE_COMPATSERVICEMETHOD = _descriptor.EnumDescriptor(
  ...
  full_name='twirk.clientcompat.ClientCompatMessage.CompatServiceMethod',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_EMPTY = _descriptor.Descriptor(
  name='Empty',
  full_name='twirk.clientcompat.Empty',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='twirk.clientcompat.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='v', full_name='twirk.clientcompat.Req.v', index=0,
...
_RESP = _descriptor.Descriptor(
  name='Resp',
  full_name='twirk.clientcompat.Resp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='v', full_name='twirk.clientcompat.Resp.v', index=0,
...
_CLIENTCOMPATMESSAGE = _descriptor.Descriptor(
  ...
  full_name='twirk.clientcompat.ClientCompatMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service_address', full_name='twirk.clientcompat.ClientCompatMessage.service_address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method', full_name='twirk.clientcompat.ClientCompatMessage.method', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request', full_name='twirk.clientcompat.ClientCompatMessage.request', index=2,
...
Empty = _reflection.GeneratedProtocolMessageType('Empty', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:twirk.clientcompat.Empty)
  ))
...
Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
  DESCRIPTOR = _REQ,
  __module__ = 'clientcompat_pb2'
  # @@protoc_insertion_point(class_scope:twirk.clientcompat.Req)
  ))
...
Resp = _reflection.GeneratedProtocolMessageType('Resp', (_message.Message,), dict(
  DESCRIPTOR = _RESP,
  __module__ = 'clientcompat_pb2'
  # @@protoc_insertion_point(class_scope:twirk.clientcompat.Resp)
  ))
...
ClientCompatMessage = _reflection.GeneratedProtocolMessageType('ClientCompatMessage', (_message.Message,), dict(
  ...
  __module__ = 'clientcompat_pb2'
  # @@protoc_insertion_point(class_scope:twirk.clientcompat.ClientCompatMessage)
  ))
...
_COMPATSERVICE = _descriptor.ServiceDescriptor(
  name='CompatService',
  full_name='twirk.clientcompat.CompatService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Method',
    full_name='twirk.clientcompat.CompatService.Method',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='NoopMethod',
    full_name='twirk.clientcompat.CompatService.NoopMethod',
    index=1,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_EMPTY,

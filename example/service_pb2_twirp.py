...
class HaberdasherClient(object):
    ...
    def __init__(self, server_address):
        ...
        self.__service_name = "twitch.twirk.example.Haberdasher"
    ...
    def make_hat(self, size):
        ...
        serialize = _sym_db.GetSymbol("twitch.twirk.example.Size").SerializeToString
        deserialize = _sym_db.GetSymbol("twitch.twirk.example.Hat").FromString
